...
{
    // did not get
    // backtobackswe solution Oexponential time On + recursion space
private:
    bool canPartition(int iterationStart, vector<int> &arr, vector<bool> &used, int k,
...
public:
    ...
    */
        ...
        return canPartition(0, arr, used, k, 0, sumOfAllArrayItems / k);
    }
};
